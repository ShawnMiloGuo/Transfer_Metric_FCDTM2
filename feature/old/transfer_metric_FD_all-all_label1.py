...
def feature_and_index_batch(iterator_val_loader, model_device, model, label_index = None):
    '''
...
def feature_and_index_all_batch(val_loader, model_device, model,  label_index = None):
    '''
    OA, F1, miou, precision, recall, feature_source_mean, feature_source_var
    '''
    index_list = []
    ...
    feature_var = torch.var(torch.tensor(extracted_features), dim=0).flatten().cpu()
...
if __name__ == "__main__":
    ...
    result_path = r"E:\Yiling\at_SIAT_research\z_result\20240621_transfer_metric_FID\20240621_transfer_metric_FID_decoder_all-all_1_dwqs2-xjs2_batch4_150img"
    ...
    main(model_path_prefix=model_path_prefix,
         ...
         target_domain_all=True, # True: all, False: batch
         )
